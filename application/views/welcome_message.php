...
<head>
    ...
    <link href="<?=base_url()?>asset/css/bootstrap-theme.min.css" rel="stylesheet">
...
<div id="subscribe">
	<div class="container subs">
		<div class="inputsubs text-center">
			...
			<input class="boxsubs" type="password" name="subscribe" placeholder="Email"></input>
		...
		<div class="col-sm-6 kanan" style="padding-left: 150px;"> 
			 ...
			 <div class="info">
			 	...
			 	<div class="inf" style="padding-top: 10px">
			 		<p><img src="asset/img/mail.png" style="padding-right: 10px;">team5rpl@gmail.com</p>
			 	</div>
			 	<div class="inf" style="padding-top: 10px">
			 		<p><img src="asset/img/contact.png" style="padding-right: 10px;">+6289653519025</p>
			 	</div>
			 </div>
			 <div class="socmed">
